    ...
    return (
        <div className="baner-container">
            ...
            <div>
                ...
                <Link href={"https://frederikssundfodboldgolf.dk/"} >
            ...
            <div>
                ...
                <Link href={"https://orstedoutdoor.dk/fodboldgolf"} >
            ...
            <div>
                ...
                <Link href={"https://fodboldgolfpark.dk/?gad_source=1&gad_campaignid=21580334316&gbraid=0AAAAA98f0jICby-G_VPEX_J3rgmaIq-Xf&gclid=CjwKCAjwx8nCBhAwEiwA_z__03vxpjHVeRYrIbqgt8Kg51tz16S9MghVj2aJ1kdo288QH8_Wm1n8rRoCnQUQAvD_BwE"} >
            ...
            <div>
                ...
                <h2 className="section-heading">Fodboldgolfen, Hårlev</h2>
                <Link href={"https://fodboldgolfen.dk/"} >
            ...
            <div>
                ...
                <Link href={"https://www.odsherred-fodboldgolf.dk/"} >
            ...
            <div>
                ...
                <Link href={"https://kragerup.dk/aktivitetspark/fodboldgolf/"} >
            ...
            <div>
                ...
                <h2 className="section-heading">VestFyns Fodboldgolf Assens </h2>
                <Link href={"https://vestfyns-fodboldgolf.dk/kontakt.html"} >
                    Kragerup Gods Hjemmeside
                </Link>
            </div>
            ...
            <div>
                ...
                <h2 className="section-heading">Bramdrupdam</h2>
            ...
            <div>
                ...
                <Link href={"https://www.hejnsvig-fodboldgolf.dk/"} >
            ...
            <div>
                ...
                <Link href={"https://www.facebook.com/p/Hegnsholt-Fodboldgolf-61567089463610/"} >
                    Hegnsholts Facebook
                </Link>
            </div>
            <hr className="divider" />
            <div>
                ...
                <h2 className="section-heading">Filskov</h2>
                <p>hvor jeg var med til at arrangere EM i Fodboldgolf i år 2025</p>
                <Link href={"https://www.filskovfodboldgolf.dk/"} >
                    Filskovs Hjemmeside
                </Link>
            </div>
            <hr className="divider" />
            <div>
                ...
                <Link href={"https://varde-fodboldgolf.dk/information/velegnet-til"} >
                    Vardes Hjemmeside
                </Link>
            </div>
            <hr className="divider" />
            <div>
                ...
                <Link href={"https://fodboldgolffaengslet.dk/"} >
            ...
            <div>
                ...
                <Link href={"https://asvigfodboldgolf.dk/"} >
            ...
            <div>
                ...
                <Link href={"https://skejbyfodboldgolf.dk/"} >
                    Skejbys Hjemmeside
                </Link>
            </div>
            <hr className="divider" />
            <div>
                ...
                <h2 className="section-heading">Randers</h2>

                <Link href={"https://randersfodboldgolf.dk/"} >
                    Randers Hjemmeside
                </Link>
            </div>
            <hr className="divider" />
            <div>
                ...
                <Link href={"https://jbfodboldgolf.dk/index.php"} >
            ...
            <div>
                ...
                <Link href={"https://www.vendsysselfodboldgolf.dk/"} >
            ...
            <div>
                ...
                <Link href={"https://nordjyskfodboldgolf.dk/"} >
            ...
            <div>
                ...
                <Link href={"http://www.futbolgolf.com/en/"} >
            ...
            <div>
                ...
                <Link href={"https://www.facebook.com/auvergnefootgolf"} >
                    Youxs Facebook
                </Link>
            </div>
                       <hr className="divider" />
            ...
            <div>
                ...
                <Link href={"https://cornwallfootballgolf.co.uk/"} >
            ...
            <div>
                ...
                <h2 className="section-heading">Baner jeg har spillet i alfabetisk rækkefølge: </h2>
